...
// Query untuk mengambil rekap absensi per siswa untuk masing-masing sesi (tipe_id)
...
// Query untuk card rekap (izin, sakit, alpha) hanya dari absensi sesi masuk
...
// Inisialisasi array untuk card rekap
$cardData = [
    'izin'  => 0,
    'sakit' => 0,
    'alpha' => 0
...
<div class="shadow-lg rounded-lg bg-white p-3 w-[83%] h-auto ml-64 mt-20">
    ...
    <!-- Card Rekap (Izin, Sakit, Alpha) berdasarkan data sesi masuk -->
    ...
    <form method="post" action="export_excel_rekap.php" class="mb-4">
